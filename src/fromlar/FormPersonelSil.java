...
public class FormPersonelSil extends javax.swing.JFrame {
    ...
    public FormPersonelSil(JButton jButton1, JPanel jPanel1, JScrollPane jScrollPane1, JTable tabloPersonel) throws HeadlessException {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormPersonelSil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormPersonelSil().setVisible(true);
            }
        });
    }
