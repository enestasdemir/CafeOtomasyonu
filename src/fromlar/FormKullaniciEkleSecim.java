...
public class FormKullaniciEkleSecim extends javax.swing.JFrame {
    ...
    public void personelDoldur() {
        ...
        try {
            ...
            while (rs.next()) {
                dtm.addRow(new String[]{rs.getString(1), rs.getString(7), rs.getString(4), rs.getString(5)});
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        FormKullaniciEkle fke = new FormKullaniciEkle();
        fke.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormKullaniciEkleSecim.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormKullaniciEkleSecim().setVisible(true);
            }
        });
    }
