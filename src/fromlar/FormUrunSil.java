...
public class FormUrunSil extends javax.swing.JFrame {
    ...
    public void gridUrun(int rows, int cols) {
        ...
        for (Urun item : uls) {
            ...
            button.addActionListener((ActionEvent e) -> {
                System.out.println("bid = " + Integer.valueOf(uid));
                Urun urun = new Urun();
                urun.setID(uid);
                int cevap = JOptionPane.showConfirmDialog(rootPane, "(" + uid + ") Ürünü silmek istediğinize emin misiniz?", "Ürün Sil", JOptionPane.YES_NO_OPTION);
                if (cevap == 0) {
                    new UrunCrud().sil(urun);
                    menuVeriCek();
                    gridMenu(0, 2);
                    urunVeriCek();
                    gridUrun(0, 5);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormUrunSil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormUrunSil().setVisible(true);
            }
        });
    }
